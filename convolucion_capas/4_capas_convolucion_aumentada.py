...
from preparacion.creacion_red_neuronal_4capas import red_neuronal_4_capas
...
def main():
    ...
    modelo_json = red_neuronal_4_capas().to_json()
    with open("modelo/modelo_4convoluciones.json", "w") as json_file:
        json_file.write(modelo_json)

    # serializar pesos a HDF5
    red_neuronal_4_capas().save_weights("modelo/modelo_4convoluciones.h5")
